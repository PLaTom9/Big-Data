...
// MAGIC %sql select action, date_format(window.end, "MMM-dd HH:mm") as time, count from iloscAKcji
...
// MAGIC %sql select action, date_format(window.end, "MMM-dd HH:mm") as time, count from zliczenia order by time, action
...
// MAGIC %sql
// MAGIC select action, date_format(window.end, "MMM-dd HH:mm") as time, count from zliczenia order by time, action 
